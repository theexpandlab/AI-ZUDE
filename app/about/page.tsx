 ...
 * first person, the team, how we work, and press/podcast contact.
 *
...
const TEAM = [
  { name: "Hannah Andersen", role: "Founder & CEO", body: "Runs Discovery and Architecture on every build, so the strategy is set before anything gets made." },
  { name: "Edielynne", role: "Publishing lead", body: "Turns your expertise into structured curriculum and gets the product built and shipped." },
  { name: "Jhon", role: "Design lead", body: "Makes everything look like the caliber of your work, not a platform template." },
  { name: "A curated contractor bench", role: "Specialists", body: "Copy, automation and launch specialists brought in per build, managed by us, never handed to you." },
];
      ...
      <section style={{ padding: "clamp(56px,7vw,100px) 24px" }}>
        <div style={wrap}>
          ...
          <p style={{ ...bodyText("62ch"), marginTop: "clamp(32px,4vw,48px)" }}>
            Press and podcast inquiries: email{" "}
            <a href={`mailto:${FACTS.email}`} style={{ color: "#8EA6FF", borderBottom: "1px solid rgba(124,150,232,0.5)" }}>
              {FACTS.email}
            </a>
            .
          </p>
